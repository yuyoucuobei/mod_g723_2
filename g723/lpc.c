 ...
 */
  ...
  */
            ...
            /* Update memory */
            CodStat.WghtIirDl[0] = rounds( Acc0 ) ;
...
*PrevErr )
{
  ...
  */
        ...
        Dpnt[i] = shl( rounds( Acc1 ), (Word16) 1 ) ;
  ...
  */
        ...
        CodStat.RingFirDl[0] = rounds( Acc1 ) ;
        ...
        CodStat.RingIirDl[0] = rounds( Acc0 ) ;
...
void     Synt( Word16 *Dpnt, Word16 *Lpc )
{
  ...
  */
        ...
        DecStat.SyntIirDl[0] = rounds( Acc0 ) ;
...
Word32  Spf( Word16 *Tv, Word16 *Lpc )
{
  ...
  */
        ...
        DecStat.PostIirDl[0] = rounds( Acc0 ) ;
