...
Word16 mult_r(Word16 var1, Word16 var2);  /* Mult with rounds,     2 */
Word32 L_shl(Word32 L_var1, Word16 var2); /* Long shift left,     2 */
Word32 L_shr(Word32 L_var1, Word16 var2); /* Long shift right,    2 */
Word16 shr_r(Word16 var1, Word16 var2);/* Shift right with rounds, 2 */
...
Word32 L_shr_r(Word32 L_var1, Word16 var2);/* Long shift right with rounds, 
 3*/
