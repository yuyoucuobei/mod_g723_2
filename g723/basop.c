...
/*___________________________________________________________________________
 ...
 |   bit number:                                                             |
 |               rounds(L_var1) = extract_h(L_add(L_var1,32768))              |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
Word16 mult_r(Word16 var1, Word16 var2)
{
    ...
    L_produit_arr += (Word32) 0x00004000L;        /* rounds */
...
/*___________________________________________________________________________
 ...
 |            mac_r(L_var3,var1,var2) = rounds(L_mac(Lvar3,var1,var2))        |
 |                                                                           |
 |   Complexity weight : 2                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
/*___________________________________________________________________________
 ...
 |            msu_r(L_var3,var1,var2) = rounds(L_msu(Lvar3,var1,var2))        |
 |                                                                           |
 |   Complexity weight : 2                                                   |
 |                                                                           |
 |   Inputs :                                                                |
